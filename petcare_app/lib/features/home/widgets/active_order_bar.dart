...
class ActiveOrderBar extends StatelessWidget {
  ...
  final List<MockActiveOrder> orders;
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      '${order.providerName} · '
                      '${thoiGianConLai(context.l10n, order.remainingMinutes)}',
...
class _LiveDotState extends State<_LiveDot>
  ...
  Widget build(BuildContext context) {
    ...
    return ScaleTransition(
      scale: Tween(begin: 1.0, end: 0.9).animate(curve),
      child: Container(
        width: 10,
        height: 10,
        decoration: BoxDecoration(
